...
docker buildx build . --build-arg RUST_RELEASE_MODE=release --platform linux/arm64 --file ./docker/Dockerfile --tag="modeh93/lemmy:$LEMMY_VERSION-linux-arm64" || exit 1;
